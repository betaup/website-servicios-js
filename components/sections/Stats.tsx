...
export const StatsSection: React.FC = () => {
  const { ref, isVisible } = useScrollReveal({ threshold: 0.2, delay: 150 });

  return (
    <section
      ref={ref}
      className={`py-20 bg-brand-900 text-white relative overflow-hidden transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}
    >
      {/* Abstract shapes */}
